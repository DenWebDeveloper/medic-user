                        ...
                        <div className="col m4 s12">
                            <div className="row">
                                ...
                                <div className="input-field col s12"><i className="material-icons prefix">textsms</i>
                                    <input className="autocomplete" id="autocomplete-input" type="text" placeholder="Введіть свою почту"/>
                                </div>
                                <div className="col s12"><small>Ми ніколи не будемо ділитися вашою електронною поштою з ким-небудь ще.</small></div>
                            </div>
                        </div>
                    </div>
                </div>
